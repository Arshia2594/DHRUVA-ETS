...
//           className={`
//             relative px-4 py-3 font-medium text-gray-700 dark:text-gray-200
//             transition-colors duration-200
//             hover:text-blue-600 dark:hover:text-blue-400
//             ${value === index ? `text-blue-600 dark:text-blue-400 font-semibold` : ""}
//             ${tabStyles}
//           `}
//         >
//           {tab.label}
...
// src/components/common/CustomTabs.jsx
