...
//               <button
//                 onClick={onAddClick}
//                 className="flex items-center gap-1 px-4 py-2 bg-teal-500 hover:bg-teal-600 text-white font-medium rounded-md shadow transition"
//               >
...
//         >
//           {showFilters && (
//             <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg space-y-4 border border-gray-200 dark:border-gray-700">
...
//                       className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm focus:ring-2 focus:ring-teal-400 focus:outline-none dark:bg-gray-800 dark:text-white"
//                       value={filters[field] || ""}
