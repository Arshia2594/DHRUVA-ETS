...
//   "IT", "Design", "Sales", "DesignProject", "Project-Automation", "IT-OT", "IT-Infra structure"
// ];
// const maritalStatusOptions = ["Single", "Married", "Divorced", "Widowed"];
// const employeeTypeOptions = ["Permanent", "Contract", "Intern"];
...
//           <FormikDatePicker name="BirthDate" label="Birth Date" className="w-full" />
...
//           <FormikDatePicker name="JoiningDate" label="Joining Date" className="w-full" />
